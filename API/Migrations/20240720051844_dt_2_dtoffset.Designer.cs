...
namespace school_admin_api.Migrations
{
    ...
    [Migration("20240720051844_dt_2_dtoffset")]
    partial class dt_2_dtoffset
    {
            ...
            modelBuilder.Entity("school_admin_api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "",
                            BirthDate = new DateTimeOffset(new DateTime(2024, 7, 20, 5, 18, 43, 620, DateTimeKind.Unspecified).AddTicks(5868), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 7, 20, 5, 18, 43, 620, DateTimeKind.Unspecified).AddTicks(5872), new TimeSpan(0, 0, 0, 0, 0)),
                            ...
                            Rut = "19",
                            StateId = (byte)1,
                            UpdatedAt = new DateTimeOffset(new DateTime(2024, 7, 20, 5, 18, 43, 620, DateTimeKind.Unspecified).AddTicks(5873), new TimeSpan(0, 0, 0, 0, 0)),
                            UserName = "admin"
                        },
                        new
                        {
                            ...
                            Address = "",
                            BirthDate = new DateTimeOffset(new DateTime(1983, 7, 20, 5, 18, 43, 620, DateTimeKind.Unspecified).AddTicks(5952), new TimeSpan(0, 0, 0, 0, 0)),
                            CreatedAt = new DateTimeOffset(new DateTime(2024, 7, 20, 5, 18, 43, 620, DateTimeKind.Unspecified).AddTicks(6042), new TimeSpan(0, 0, 0, 0, 0)),
                            Email = "fdovarasc@gmail.com",
                            FirstName = "Fernando",
                            Gender = (byte)0,
                            LastName = "Varas",
                            ...
                            Rut = "15111222K",
                            StateId = (byte)1,
                            UpdatedAt = new DateTimeOffset(new DateTime(2024, 7, 20, 5, 18, 43, 620, DateTimeKind.Unspecified).AddTicks(6044), new TimeSpan(0, 0, 0, 0, 0)),
                            UserName = "fvaras"
                        });
                });
