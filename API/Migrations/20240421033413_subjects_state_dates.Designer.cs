...
namespace school_admin_api.Migrations
{
    ...
    [Migration("20240421033413_subjects_state_dates")]
    partial class subjects_state_dates
    {
            ...
            modelBuilder.Entity("school_admin_api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "",
                            BirthDate = new DateTime(2024, 4, 20, 23, 34, 12, 278, DateTimeKind.Local).AddTicks(5335),
                            CreatedAt = new DateTime(2024, 4, 20, 23, 34, 12, 278, DateTimeKind.Local).AddTicks(5380),
                            ...
                            Rut = "19",
                            StateId = (byte)1,
                            UpdatedAt = new DateTime(2024, 4, 20, 23, 34, 12, 278, DateTimeKind.Local).AddTicks(5385),
                            UserName = "admin"
                        });
                });
