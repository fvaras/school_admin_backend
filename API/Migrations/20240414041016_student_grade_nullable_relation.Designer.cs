...
namespace school_admin_api.Migrations
{
    ...
    [Migration("20240414041016_student_grade_nullable_relation")]
    partial class student_grade_nullable_relation
    {
            ...
            modelBuilder.Entity("school_admin_api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "",
                            BirthDate = new DateTime(2024, 4, 14, 0, 10, 15, 344, DateTimeKind.Local).AddTicks(3185),
                            CreatedAt = new DateTime(2024, 4, 14, 0, 10, 15, 344, DateTimeKind.Local).AddTicks(3246),
                            ...
                            Rut = "19",
                            StateId = (byte)1,
                            UpdatedAt = new DateTime(2024, 4, 14, 0, 10, 15, 344, DateTimeKind.Local).AddTicks(3251),
                            UserName = "admin"
                        });
                });
