...
namespace school_admin_api.Migrations
{
    ...
    [Migration("20240512042502_plannings_timeblocks")]
    partial class plannings_timeblocks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlanningTimeBlock", b =>
                {
                    ...
                    b.HasKey("PlanningsId", "TimeBlocksId");

                    b.HasIndex("TimeBlocksId");

                    b.ToTable("PlanningTimeBlock", "public");
                });
            ...
            modelBuilder.Entity("school_admin_api.Model.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Address = "",
                            BirthDate = new DateTime(2024, 5, 12, 0, 25, 0, 663, DateTimeKind.Local).AddTicks(9478),
                            CreatedAt = new DateTime(2024, 5, 12, 0, 25, 0, 663, DateTimeKind.Local).AddTicks(9531),
                            ...
                            Rut = "19",
                            StateId = (byte)1,
                            UpdatedAt = new DateTime(2024, 5, 12, 0, 25, 0, 663, DateTimeKind.Local).AddTicks(9536),
                            UserName = "admin"
                        });
                });
            ...
            modelBuilder.Entity("PlanningTimeBlock", b =>
                {
                    b.HasOne("school_admin_api.Model.Planning", null)
                        .WithMany()
                        .HasForeignKey("PlanningsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("school_admin_api.Model.TimeBlock", null)
                        .WithMany()
